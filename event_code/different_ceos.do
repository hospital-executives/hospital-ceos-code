...
summarize_turnover , cond("balanced_2_year_sample") 	prefix(restricted_tar_2)
...
summarize_turnover , cond("balanced_2_year_sample & tar_reltime < 0") 	prefix(pre_restricted_tar_2)
summarize_turnover , cond("balanced_3_year_sample & tar_reltime < 0") 	prefix(pre_restricted_tar_3)

foreach v in never_m_and_a never_tar full_tar restricted_tar_2 restricted_tar_3 ///
	pre_full_tar pre_restricted_tar_2 pre_restricted_tar_3{
...
"Balanced 2 year treated sample (tar) & `restricted_tar_2_mean_str' & `restricted_tar_2_se_str' & `restricted_tar_2_N_str' & `restricted_tar_2_nent_str'\\\\\n " ///
"Balanced 3 year treated sample (tar) & `restricted_tar_3_mean_str' & `restricted_tar_3_se_str' & `restricted_tar_3_N_str' & `restricted_tar_3_nent_str'\\\\\n " ///
...
"Balanced 2 year treated sample : pre-period only (tar)& `pre_restricted_tar_2_mean_str' & `pre_restricted_tar_2_se_str' & `pre_restricted_tar_2_N_str' & `restricted_tar_2_nent_str'\\\\\n " ///
"Balanced 3 year treated sample : pre-period only (tar)& `pre_restricted_tar_3_mean_str' & `pre_restricted_tar_3_se_str' & `pre_restricted_tar_3_N_str' & `restricted_tar_3_nent_str'\\\\\n " ///
"\bottomrule\n" ///
"\end{tabular}\n" ///
"\end{table}\n"
file close out
